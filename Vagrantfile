...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  servers.each do |key, value|
    ...
    if ENV['VAGRANT_MOUNT'] == 'nfs'
      config.vm.synced_folder "./", "/var/www/winemeup", type: "nfs", nfs_export: true
    else
      config.vm.synced_folder "./", "/var/www/winemeup", owner: "www-data", group: "www-data"
    end
    config.vm.synced_folder "./", "/home/vagrant/winemeup", owner: "vagrant", group: "vagrant"
    config.vm.synced_folder "./", "/home/symfony/winemeup", mount_options: ["uid=1002", "gid=1002"], disabled: true
